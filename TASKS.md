...
| [002](tasks/002_instructor-user-lookup.md)                        | Add Instructor User lookup field to Course                                   | done   |
...
| [013](tasks/013_my-courses-list-view-page.md)                     | Add My Courses list view page to Experience Site                             | done   |
...
| [021](tasks/021_semester-identifier.md)                           | Add semester identifier to config metadata and Course object                 | done   |
...
| [037](tasks/037_course-plan-error-labels-expansion.md)            | Use custom labels for remaining CoursePlan-related error messages            | open   |
...
- **deferred** — intentionally paused or deprioritized
